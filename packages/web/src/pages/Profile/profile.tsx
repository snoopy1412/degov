...
export const Profile = ({ address }: ProfileProps) => {
  ...
  const isOwnProfile = useMemo(() => {
    ...
    return isAddress(address) && account.toLowerCase() === address.toLowerCase();
  }, [address, account]);
      ...
      <div className="grid grid-cols-[1fr_400px] gap-[20px]">
        ...
        <div className="flex flex-col gap-[20px] rounded-[14px] bg-card p-[20px]">
          ...
          <p className="mb-0 line-clamp-2 text-[14px] font-normal leading-normal text-foreground">
            L2BEAT is an independent, public goods company who acts as an impartial watchdog for the
            Ethereum Layer2 ecosystem. Our mission is to provide comprehensive and unbiased analysis
            and comparative evaluations of Layer 2 solutions . We are committed to the verification
            and fact-checking of the claims made by each project, with a special focus on the
            security aspects. What sets L2BEAT apart is our unwavering commitment to delivering
