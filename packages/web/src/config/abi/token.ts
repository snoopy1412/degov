export const abi = [
  ...
  },
  {
    inputs: [],
    name: 'DEPOSIT',
    outputs: [{ internalType: 'contract IDeposit', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'dps', type: 'address' },
      { internalType: 'string', name: 'name', type: 'string' },
  ...
  { inputs: [], name: 'wrapRING', outputs: [], stateMutability: 'payable', type: 'function' }
] as const;
