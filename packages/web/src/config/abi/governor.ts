export const abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract TimelockControllerUpgradeable', name: 'timelock', type: 'address' },
      { internalType: 'uint48', name: 'initialVotingDelay', type: 'uint48' },
      { internalType: 'uint32', name: 'initialVotingPeriod', type: 'uint32' },
      { internalType: 'uint256', name: 'initialProposalThreshold', type: 'uint256' },
      { internalType: 'string', name: 'name', type: 'string' }
    ],
    name: 'initialize',
    outputs: [],
