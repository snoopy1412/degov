...
export const VoteStatus: FC<VoteStatusProps> = ({ variant, className }) => {
  return (
    ...
    >
      <img src={text[variant].icon} alt={text[variant].label} width={20} height={20} />
...
export const VoteStatusAction: FC<VoteStatusActionProps> = ({ variant, className, type }) => {
  ...
  return (
    <div
      className={cn(
        ...
        isActive ? 'border border-transparent' : 'border border-muted-foreground',
        className
      )}
